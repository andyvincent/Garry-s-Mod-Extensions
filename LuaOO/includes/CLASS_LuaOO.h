...
public:
  ...
  */
  void registerPollingFunction(ILuaInterface* luaInterface, const char* hookName);

  /*!
    \brief Register all the classes added.
    \param luaInterface Lua interface.
  */
  void registerClasses(ILuaInterface* luaInterface);
  ...
  */
  static bool checkArgument(ILuaInterface* luaInterface, int stackPosition, int expectedType);
private:
  ...
  */
  ...
  /*!
    ...
    \param classInfo Class info to register
  */
  void registerClass(ILuaInterface* luaInterface, LuaClassInfo* classInfo);

  /*!
    \brief Lua wrapper for the polling hook
  */
  LUA_FUNCTION(pollingFunction);
